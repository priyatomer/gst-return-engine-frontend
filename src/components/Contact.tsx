...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-padding bg-[#0A0F1E] relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          >
            ...
            <motion.a
              ...
              className="glass rounded-xl p-4 flex items-center gap-3 border border-emerald-500/20 hover:border-emerald-400/40 transition-all"
            >
          ...
          >
            <div className="glass rounded-2xl p-8">
              {submitted ? (
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-emerald-400/10 flex items-center justify-center text-emerald-400">
                    <CheckCircle2 size={36} />
                  </div>
                  <h3 className="text-white text-2xl font-black">Message Received!</h3>
                  <p className="text-slate-400 max-w-sm">
                    Thank you for reaching out. One of our experts will contact you within 24
                    business hours.
                  </p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={4}
                      placeholder="Tell us about your business needs, current challenges, or what you'd like help with..."
